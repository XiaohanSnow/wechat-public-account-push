...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'oZ8dN5kdYGm4kWhW-sIEUWFHWQIo',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '9neofIKQR2YuQPBJjATRPblsV53JpF10k6JBKAFSk8w',
      // 所在省份
      province: '四川',
      // 所在城市
      city: '成都',
      ...
      openUrl: 'https://gushitong.baidu.com/index/ab-000001',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '生日', name: '宝', year: '1998', date: '11-24',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2021-09-31' },
        // 结婚纪念日
    ...
    },
    {
      ...
      name: '倪潇晗',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'oZ8dN5j94yGWJZBV_4zqhD-f0J00',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '9neofIKQR2YuQPBJjATRPblsV53JpF10k6JBKAFSk8w',
      // 所在省份
      province: '四川',
  ...
  CALLBACK_TEMPLATE_ID: 'hqwmZxmrH-qAAJUG6QP790mm4-A9_V6SQeFAnHIrnrM',
